import { c as create_ssr_component, f as compute_rest_props, v as validate_component, q as createEventDispatcher, a as subscribe, h as spread, i as escape_attribute_value, j as escape_object, d as add_attribute, g as getContext, s as setContext, l as get_store_value } from './ssr-DTSylQif.js';
import { c as cn, J as disabledAttrs, A as is_void, d as createBitAttrs, r as removeUndefined, g as getOptionUpdater, w as withGet, t as toWritableStores, o as omit, m as makeElement, z as isHTMLElement$1, y as noop, k as safeOnMount, i as isBrowser, l as executeCallbacks, K as addEventListener, x as kbd, n as addMeltEventListener, e as effect, L as safeOnDestroy, F as nanoid, h as tick, M as isFunction, u as useEscapeKeydown, q as createElHelpers, s as styleToString, p as portalAttr, v as isElement$1, N as FIRST_LAST_KEYS, S as SELECTION_KEYS, O as isElementDisabled, f as createSeparator, H as disabledAttr } from './card-title-C6YlrkIb.js';
import { d as derived, w as writable, b as readonly } from './index-wq-T43VL.js';
import 'clsx';
              ...
              options: {
                ...
                modal: {
                  ...
                  shouldCloseOnInteractOutside: (e) => {
                    ...
                    if (!menubarEl || !isElement$1(target))
                      return true;
...
const Menubar$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { el = void 0 } = $$props;
  const { elements: { menubar }, updateOption, ids, getMenubarAttrs } = setCtx({ loop, closeOnEscape, preventScroll });
...
export { Menubar as M, Menu as a, Menubar_item as b, createDispatcher as c, derivedVisible as d, getPortalDestination as e, usePortal as f, generateIds as g, handleFocus as h, handleRovingFocus as i, last as l, next as n, overridable as o, prev as p, removeScroll as r, sleep as s, usePopper as u };
//# sourceMappingURL=index2-DmYOMU5P.js.map
